...
class ReceiptVolun extends React.Component {
  static propTypes = {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      uniqueType: [],
      allBoxes: [],
      targetMember: this.props.affiliation,
    }
  }
...
export default connect(mapStateToProps)((withMeta(ReceiptVolun)));
